...
flags.DEFINE_list('decoder_filters_instance', [128, 32], 'Instance Decoder filters.')
...
LABEL = 'label'
LABEL_INSTANCE = 'label_instance_center'
LABEL_OFFSET = 'label_offset'
LABEL_INSTANCE_IDS = 'instance_ids_data'
...
class ModelOptions(
  ...
  def __new__(cls,
    ...
    return super(ModelOptions, cls).__new__(
        ...
        FLAGS.decoder_filters_instance,
