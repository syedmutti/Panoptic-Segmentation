...
def streaming_panoptic_quality(groundtruth_categories,
  ...
  input_args = [
      tf.convert_to_tensor(groundtruth_categories, tf.int32),
      tf.convert_to_tensor(groundtruth_instances, tf.uint8),
      tf.convert_to_tensor(predicted_categories, tf.int64),
      tf.convert_to_tensor(predicted_instances, tf.int32),
